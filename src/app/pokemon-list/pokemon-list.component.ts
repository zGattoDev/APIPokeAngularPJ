...
export class PokemonListComponent implements OnInit {
  ...
  loadPokemonList(): void {
    this.pokeapiService.getPokemonList(this.currentPage).subscribe((data: any) => {
  ...
  search(): void {
    if (this.searchTerm.trim() !== '') {
      this.pokeapiService.getPokemonDetails(this.searchTerm.toLowerCase()).subscribe((data: any) => {
